  ...
  const questions = [
    {
      ...
      name: 'Alice',
      timeAgo: formatDistance(subHours(new Date(), 2), new Date(), {
        addSuffix: true,
      }),
    ...
    },
    {
      ...
      name: 'Max',
      timeAgo: formatDistance(subDays(new Date(), 1), new Date(), {
        addSuffix: true,
      }),
    ...
    },
    {
      ...
      name: 'Sophia',
      timeAgo: formatDistance(subHours(new Date(), 12), new Date(), {
        addSuffix: true,
      }),
