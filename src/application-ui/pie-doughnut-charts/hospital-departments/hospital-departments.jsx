  ...
  const departments = [
    {
      ...
      bedData: [
        {
          label: 'Occupied beds',
          color: alpha(theme.palette.warning.light, 0.7),
          value: 25,
        },
        {
          label: 'Free beds',
      ...
      doctorData: [
        {
          ...
          color: alpha(theme.palette.info.light, 0.7),
          value: 10,
        },
        {
          label: 'Busy doctors',
          color: alpha(theme.palette.info.dark, 0.9),
          value: 5,
        },
      ],
    },
...
const DepartmentPieChart = ({ theme, title, data }) => {
