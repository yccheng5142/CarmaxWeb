...
const Component = () => {
  ...
  const [selectedOptions, setSelectedOptions] = useState(settingsOptions[0].title.split(','));
  const [selectedProjects, setSelectedProjects] = useState(projectOptions[0].title.split(','));
