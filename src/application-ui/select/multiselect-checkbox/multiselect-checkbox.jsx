...
const Component = () => {
  ...
  const settingsOptions = [
    ...
    {
      title: t('System Logs'),
      description: 'View system operation logs and activities.',
    },
    {
    ...
    },
    {
      ...
      description: 'Configure firewalls and encryption.',
    },
    {
      title: t('Notification Preferences'),
      description: 'Set up alert thresholds and channels.',
    },
  ];
  const projectOptions = [
    {
      title: t('Resource Allocation'),
      description: 'Assign resources to projects and tasks.',
    },
    {
      title: t('Budget Tracking'),
      description: 'Monitor project budgets and financials.',
    },
    {
      title: t('Risk Assessment'),
      description: 'Evaluate potential risks and mitigation plans.',
    },
    {
  ...
  const [selectedSettings, setSelectedSettings] = useState(settingsOptions[2].title.split(','));
  const [selectedProjects, setSelectedProjects] = useState(projectOptions[2].title.split(','));
