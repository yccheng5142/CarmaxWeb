import AccordionsSvg from 'src/components/base/components-svgs/accordions.svg?react';
import AlertsSvg from 'src/components/base/components-svgs/alerts.svg?react';
import AreaChartsSvg from 'src/components/base/components-svgs/area-charts.svg?react';
import AutocompleteSvg from 'src/components/base/components-svgs/autocomplete.svg?react';
import AvatarsSvg from 'src/components/base/components-svgs/avatars.svg?react';
import BadgesSvg from 'src/components/base/components-svgs/badges.svg?react';
import BarChartsSvg from 'src/components/base/components-svgs/bar-charts.svg?react';
import BreadcrumbsSvg from 'src/components/base/components-svgs/breadcrumbs.svg?react';
import ButtonGroupsSvg from 'src/components/base/components-svgs/button-groups.svg?react';
import ButtonsSvg from 'src/components/base/components-svgs/buttons.svg?react';
import CardHeadingsSvg from 'src/components/base/components-svgs/card-headings.svg?react';
import CardShellsSvg from 'src/components/base/components-svgs/card-shells.svg?react';
import CheckboxesSvg from 'src/components/base/components-svgs/checkboxes.svg?react';
import ChipsSvg from 'src/components/base/components-svgs/chips.svg?react';
import ComposedBlocksSvg from 'src/components/base/components-svgs/composed-blocks.svg?react';
import ComposedVisualizationBlocksSvg from 'src/components/base/components-svgs/composed-visualization-blocks.svg?react';
import ContentGridsSvg from 'src/components/base/components-svgs/content-grids.svg?react';
import ContentShellsSvg from 'src/components/base/components-svgs/content-shells.svg?react';
import DataGridListsSvg from 'src/components/base/components-svgs/data-grid-lists.svg?react';
import DatepickerSvg from 'src/components/base/components-svgs/datepicker.svg?react';
import DescriptionGridListsSvg from 'src/components/base/components-svgs/description-grid-lists.svg?react';
import DialogsSvg from 'src/components/base/components-svgs/dialogs.svg?react';
import DividersSvg from 'src/components/base/components-svgs/dividers.svg?react';
import DrawersSvg from 'src/components/base/components-svgs/drawers.svg?react';
import DropdownsSvg from 'src/components/base/components-svgs/dropdowns.svg?react';
import EmptyStatesSvg from 'src/components/base/components-svgs/empty-states.svg?react';
import FormLayoutsSvg from 'src/components/base/components-svgs/form-layouts.svg?react';
import FoundationSvg from 'src/components/base/components-svgs/foundation.svg?react';
import GaugeIndicatorsSvg from 'src/components/base/components-svgs/gauge-indicators.svg?react';
import HorizontalListsSvg from 'src/components/base/components-svgs/horizontal-lists.svg?react';
import HorizontalMenusSvg from 'src/components/base/components-svgs/horizontal-menus.svg?react';
import IconGridListsSvg from 'src/components/base/components-svgs/icon-grid-lists.svg?react';
import ImageGridListsSvg from 'src/components/base/components-svgs/image-grid-lists.svg?react';
import InputSvg from 'src/components/base/components-svgs/input.svg?react';
import LineChartsSvg from 'src/components/base/components-svgs/line-charts.svg?react';
import ListContainersSvg from 'src/components/base/components-svgs/list-containers.svg?react';
import NavigationOverlaysSvg from 'src/components/base/components-svgs/navigation-overlays.svg?react';
import NotificationsSvg from 'src/components/base/components-svgs/notifications.svg?react';
import PageHeadingsSvg from 'src/components/base/components-svgs/page-headings.svg?react';
import PaginationSvg from 'src/components/base/components-svgs/pagination.svg?react';
import PieDoughnutChatrsSvg from 'src/components/base/components-svgs/pie-doughnut-charts.svg?react';
import PopoversSvg from 'src/components/base/components-svgs/popovers.svg?react';
import ProgressGridListsSvg from 'src/components/base/components-svgs/progress-grid-lists.svg?react';
import ProgressIndicatorsSvg from 'src/components/base/components-svgs/progress-indicators.svg?react';
import RadioGroupsSvg from 'src/components/base/components-svgs/radio-groups.svg?react';
import RatingsSvg from 'src/components/base/components-svgs/ratings.svg?react';
import SectionHeadingsSvg from 'src/components/base/components-svgs/section-headings.svg?react';
import SelectSvg from 'src/components/base/components-svgs/select.svg?react';
import SkeletonSvg from 'src/components/base/components-svgs/skeleton.svg?react';
import SliderSvg from 'src/components/base/components-svgs/slider.svg?react';
import SparklineChartsSvg from 'src/components/base/components-svgs/sparkline-charts.svg?react';
import SpeedDialsSvg from 'src/components/base/components-svgs/speed-dials.svg?react';
import StackedListsSvg from 'src/components/base/components-svgs/stacked-lists.svg?react';
import StatsGridListsSvg from 'src/components/base/components-svgs/stats-grid-lists.svg?react';
import SteppersSvg from 'src/components/base/components-svgs/steppers.svg?react';
import SwitchesSvg from 'src/components/base/components-svgs/switches.svg?react';
import TablesSvg from 'src/components/base/components-svgs/tables.svg?react';
import TabsSvg from 'src/components/base/components-svgs/tabs.svg?react';
import TextareaSvg from 'src/components/base/components-svgs/textarea.svg?react';
import TimelinesSvg from 'src/components/base/components-svgs/timelines.svg?react';
import ToggleButtonsSvg from 'src/components/base/components-svgs/toggle-buttons.svg?react';
import TooltipsSvg from 'src/components/base/components-svgs/tooltips.svg?react';
import UploadSvg from 'src/components/base/components-svgs/upload.svg?react';
import UserAuthSvg from 'src/components/base/components-svgs/user-auth.svg?react';
import VerticalMenusSvg from 'src/components/base/components-svgs/vertical-menus.svg?react';
